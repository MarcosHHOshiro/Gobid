...
func NewBidsService(pool *pgxpool.Pool) BidsServices {
	return BidsServices{
		pool:    pool,
...
func (bs *BidsServices) Placebid(ctx context.Context, product_id, bidder_id uuid.UUID, amount float64) (pgstore.Bid, error) {
